...
public class WebAuthorization extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/api/clients/current","/api/clients/current/accounts", "/api/transactions","/api/clients/current/cards","/api/loans").hasAnyAuthority("ADMIN","CLIENT")
                ...
                .antMatchers("/api/clients/{id}","/api/accounts/{id}","/api/cards/{id}", "/web/cards.html", "/web/js/cards.js","/web/create-cards.html", "/web/loan-application.html","/web/transfers.html", "/web/js/create-cards.js","/web/js/loan-application.js", "/web/js/transfers.js").hasAnyAuthority("ADMIN", "CLIENT")
